var app = new Vue({
    ...
    methods: {
        ...
        encode: function (bits) {
            console.log("Use parity bit: "+this.parityBit);
            if (this.numberOfDataBits == 8) {
                ...
                if (this.parityBit=="true") {
                    var c0 = this.parity(c1 + c2 + c4 + c8 + parseInt(bits[0].data) + parseInt(bits[1].data) + parseInt(bits[2].data) + parseInt(bits[3].data)
                    ...
                    return [c1, c2, parseInt(bits[0].data), c4, parseInt(bits[1].data), parseInt(bits[2].data), parseInt(bits[3].data), c8,
                        parseInt(bits[4].data), parseInt(bits[5].data), parseInt(bits[6].data), parseInt(bits[7].data)];
                }
            } else {
                ...
                if (this.parityBit=="true") {
                    var c0 = this.parity(c1 + c2 + c4 + parseInt(bits[0].data) + parseInt(bits[1].data) + parseInt(bits[2].data) + parseInt(bits[3].data));
